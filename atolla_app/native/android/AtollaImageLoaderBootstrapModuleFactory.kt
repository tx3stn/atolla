...
import com.snap.modules.atolla_app.ImageLoaderBootstrapModule
import com.snap.modules.atolla_app.ImageLoaderBootstrapModuleFactory
...
class AtollaImageLoaderBootstrapModuleFactory : ImageLoaderBootstrapModuleFactory() {
	...
	override fun onLoadModule(): ImageLoaderBootstrapModule {
		return object : ImageLoaderBootstrapModule {
			...
			override fun setAtollaImageLoaderAuthHeader(header: String) {
				AtollaCacheImageLoader.authHeader = header.ifBlank { null }
			}
		}
	}
}
