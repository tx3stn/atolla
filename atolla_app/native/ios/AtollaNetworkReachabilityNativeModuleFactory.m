...
@interface AtollaNetworkReachabilityNativeModuleImpl : NSObject <atolla_appNetworkReachabilityNativeModule>
@end
...
- (void)setAtollaNetworkStatusObserverWithOnChange:
    (atolla_appNetworkReachabilityNativeModuleSetAtollaNetworkStatusObserverOnChangeBlock _Nonnull)
        onChange {
    [_lock lock];
...
@interface AtollaNetworkReachabilityNativeModuleFactoryImpl : atolla_appNetworkReachabilityNativeModuleFactory
@end
...
- (id<atolla_appNetworkReachabilityNativeModule> _Nonnull)onLoadModule {
