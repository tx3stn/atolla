...
@interface AtollaHapticsBootstrapModuleImpl : NSObject <atolla_appHapticsBootstrapModule>
@end
...
@interface AtollaHapticsBootstrapModuleFactoryImpl : atolla_appHapticsBootstrapModuleFactory
@end
...
- (id<atolla_appHapticsBootstrapModule>)onLoadModule {
