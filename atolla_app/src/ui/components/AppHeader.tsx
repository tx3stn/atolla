...
const styles = {
	...
	leadingFabSlot: new Style<View>({
		...
		paddingLeft: theme.scaleNav(6),
		paddingRight: theme.scaleNav(6),
		width: theme.scaleNav(60),
	}),
	root: new Style<View>({
		...
		paddingBottom: theme.scaleNav(4),
	...
	scroll: new Style<ScrollView>({
		flexGrow: 1,
		paddingTop: theme.scaleNav(4),
	}),
	scrollHint: new Style<Label>({
		...theme.text.headerTab,
	...
	scrollHintWrap: new Style<View>({
		...
		paddingLeft: theme.scaleNav(6),
		paddingRight: theme.scaleNav(10),
	}),
	...
	titleContainer: new Style<View>({
		...
		paddingLeft: theme.scaleNav(12),
		paddingRight: theme.scaleNav(12),
	}),
	titleWrap: new Style<View>({
		alignItems: 'flex-end',
		bottom: 0,
		justifyContent: 'center',
		left: theme.scaleNav(64),
		paddingRight: theme.scaleNav(16),
		position: 'absolute',
		right: 0,
		top: theme.padding.deviceInset,
	}),
	trailingSpacer: new Style<Layout>({
		width: theme.scaleNav(65),
	}),
};
